...
guilds channels messages. This program returns a leaderboard sorted by the members who've said 'drbounties' the most """
    ...
    async for each_message in ctx.channel.history(limit=None, oldest_first=True, after=days):
        if is_target_phrase(each_message):  # if this message is a target message
            ...
            if message == 'dralive':
                ...
                users_vs_total[member] = users_vs_total[member] + 0.5
